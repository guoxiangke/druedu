		              ...
		              [
		                {
		                  ...
		                  width: '40px',
		                  id : 'imageSize',
		                  label : "Select your image size",
		                  items : [ ['Original', ''], ['Small', '300'], ['Medium', '500'], ['Large', '1024']],
		                  onClick : function() {
		                    var dialog = this.getDialog();
		                    dialog.getContentElement('info', 'txtWidth').setValue(this.getValue()).onKeyUp();
		                    // Set the height to 0 so we auto-height
		            ...
		            },
		            {
		              ...
		              children : [
								...
								},
								{
									id: 'ratioLock',
									type: 'html',
									style: 'margin-top:15px;width:60px;height:40px;',
									onLoad: function() {
