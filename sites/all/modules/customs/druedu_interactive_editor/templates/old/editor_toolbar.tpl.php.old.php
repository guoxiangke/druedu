<!-- Turn the interactive editor on/off -->
<div class="row-fluid">
  <div class="span5">
    <h1>Create new <?php print $vars['#bundle']; ?> </h1>
  </div>
  <div class="span3 offset4"> <strong>Editor</strong>
    <div id="toggle_i_editor">
      <input type="checkbox">
    </div>
  </div>
</div>
...
<div class="row-fluid druedu_interactive">
  <div class="span12 add_content"> 
    ...
    <div class="tab-content"> 
      ...
      <!-- add media -->
      <div class="tab-pane active" id="media"> <?php print views_embed_view("my_media"); ?> 
        <!-- <a data-toggle="modal" href="#saveModal" class="btn btn-primary" id="savebtn">Save</a> --> 
      </div>
      
      <!-- Upload tab -->
      <div class="tab-pane row-fluid" id="upload">
        <div class="span12">
          <?php $block = module_invoke('jquery_file_upload','block_view', 'jquery_file_uploader'); print render($block);?>
        </div>
      </div>
...
<div class="row-fluid edit_content">
  <div class="span12"> 
