...
<?php
	...
	if( strpos($output, "mp4") ){
			print '<video width="320" height="240" controls="controls"><source src="'.$output.'" type="video/mp4" />Your browser does not support the video tag.</video>';
	}else{
      ...
      print $output;
      //print '<img src="'.image_style_url("my_media_thumbnails", $output).'" height="100px" data-org-height="'. $size[1] .'" data-org-width="'. $size[0].'" data-original="'. $output .'" />';
	}
